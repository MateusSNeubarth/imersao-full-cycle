...
func NewEventHandler(listEventsUseCase *usecase.ListEventsUsecase, listSpotsUseCase *usecase.ListSpotsUseCase, getEventUseCase *usecase.GetEventUseCase, buyTicketsUseCase *usecase.BuyTicketsUseCase) *EventsHandler {
